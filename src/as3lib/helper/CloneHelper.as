...
package as3lib.helper
{
	...
	/**
	 * 功能：对象赋值分浅复制和深复制，Array.concat就属于浅复制。AS3里没有深复制,这个方法也不能复制显示对象。
	 * 所谓深复制是指增加一个指针并且申请一个新的内存，而浅复制只是增加了一个指针指向已经存在的内存。
	 */
	public class CloneHelper
	{
		...
		{
			if (obj == null || obj is Class || obj is Function || isPrimitiveType(obj))
			{
				return obj;
			}
